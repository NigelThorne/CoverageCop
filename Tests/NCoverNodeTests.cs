...
namespace NCoverCop.Tests
{
    ...
    public class NCoverNodeTests
    {
        ...
        {
            var node = new NCoverNode(1, 2, 3, 4, @"C:/Manticore_Debug/trunk/trunk/trunkSomeFile.cs", 1, false, "m", 0,
                "k3", new Regex("trunk.*"));
        ...
        {
            var result = node1to5.ExtendWith(node6to10);
        ...
        {
            var result = node1to1.ExtendWith(node1to1);
            Assert.AreEqual(1, result.Line);
